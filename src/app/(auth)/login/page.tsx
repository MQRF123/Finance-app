...
export default function LoginPage() {
  ...
  const { register, handleSubmit, getValues, formState: { isSubmitting, errors } } =
    ...
    <main className="min-h-dvh grid place-items-center bg-emerald-100">
      <div className="w-full max-w-5xl bg-white rounded-2xl shadow border overflow-hidden">
        <div className="grid md:grid-cols-2">
          {/* LADO IZQ: ilustración */}
          <div className="relative bg-emerald-50 p-8">
            <div className="absolute inset-0 bg-[radial-gradient(600px_300px_at_-10%_-10%,rgba(16,185,129,.25),transparent)]" />
            <HouseKeysSVG />
          </div>
          ...
          <div className="p-8 md:p-10">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="mt-6 grid gap-3">
              ...
              <label className="text-sm">
                ...
                <div className="mt-1 flex items-center rounded-lg border px-3">
                  <input
                    ...
                    {...register("password")}
                  />
                  <button type="button" onClick={() => setShow(s => !s)} className="p-1 text-neutral-500">
              ...
              <button
                ...
                className="mt-1 rounded-lg bg-emerald-700 text-white py-2.5 hover:bg-emerald-800 disabled:opacity-60"
              >
              ...
              <button
                type="button"
                onClick={onGoogle}
                className="rounded-lg border py-2.5 hover:bg-neutral-50"
              >
              ...
              <div className="text-sm text-neutral-700">
                ...
                <Link href="/register" className="text-emerald-700 font-medium">Regístrate</Link>
              </div>
            </form>
          </div>
        </div>
...
function HouseKeysSVG() {
  return (
    <svg viewBox="0 0 420 280" className="relative z-10 w-full h-full">
